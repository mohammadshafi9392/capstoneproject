-- Punjab Job Portal Database Setup for PostgreSQL 17
-- Run this script using: psql -U postgres -d postgres -f database_setup_postgres.sql
...
CREATE TABLE IF NOT EXISTS employers (
    ...
    organization_type VARCHAR(20) CHECK (organization_type IN ('Government', 'Private')) NOT NULL,
